...
FullParks<-rbind(Parks2018,Parks2019,Parks2020)
FullParks<-FullParks%>%filter(grepl('Highland|August|Emerald View|Riverview|Mellon|Westinghouse', location_name))%>%select('location_name','placekey','visitor_home_cbgs','raw_visitor_counts','Month')
```
